...
public:
	...
	ZWorldItem *AddWorldItem( int nID, short nItemID,MTD_WorldItemSubType nItemSubType, rvector& pos, MUID OwnerUID = MUID(), MMatchTeam = MMT_ALL );	// 맵 로딩시 아이템 추가할때 호출하는 함수
