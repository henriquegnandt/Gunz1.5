...
public:
	...
	bool Reload();
	bool IsRecording;
	bool HasMusicStopped(); 
	void RecordControl(ZRecordAudioControl Audio, char* Buffer=NULL);
	// BGM
...
#define VOICE_GOT_BOUNTY			"nar/NAR30"
#define VOICE_BOUNTY_DOWN			"nar/NAR31"
#define VOICE_GOT_REVERSE_BERSERKER "nar/NAR32"	
#define VOICE_REVERSE_BERSERKER_DOWN "nar/NAR33"	
...
#define VOICE_RED_HAS_FLAG			"nar/NAR34"
#define VOICE_BLUE_HAS_FLAG			"nar/NAR35"
#define VOICE_RED_FLAG_RETURN		"nar/NAR36"
#define VOICE_BLUE_FLAG_RETURN		"nar/NAR37"
#define VOICE_RED_TEAM_SCORE		"nar/NAR38"
#define VOICE_BLUE_TEAM_SCORE		"nar/NAR39"
#define VOICE_CTF					"nar/NAR40"
