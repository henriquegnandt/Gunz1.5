...
public:
	...
	void AddMagic(ZSkill* pSkill, const rvector &pos, const rvector &dir,ZObject* pOwner, MMatchTeam t = MMT_ALL);
	...
	void AddClayMore(rvector &pos, rvector &velocity, ZCharacter* pC, float Delaytime, char *szMeshName, int nLinkedWorldItemID);
