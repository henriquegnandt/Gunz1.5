	...
	case MMIST_RANGE:
		{
			MMatchWeaponType type = pItemDesc->m_nWeaponType.Ref();
			{
				...
				case MWT_DOUBLE_GREAT_SWORD:	strcpy(szFileName, "slot_icon_D_sword"); break;
				...
				case MWT_DOUBLE_SHOTGUN: strcpy(szFileName, "slot_icon_D_shotgun"); break;
				case MWT_SAWED_SHOTGUN:	strcpy(szFileName, "slot_icon_shotgun"); break;
				case MWT_RIFLE:			strcpy(szFileName, "slot_icon_rifle"); break;
				case MWT_DOUBLE_RIFLE:  strcpy(szFileName, "slot_icon_D_rifle"); break;
...
MBitmap* GetItemThumbnailBitmap(MMatchItemDesc* pDesc)
{
	...
	sprintf(szFilePath, "Other/interface/itemicon%d.dds", pDesc->m_nID);
