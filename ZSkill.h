...
public:
	...
	void Execute(MUID& uidTarget, rvector& targetPos, MMatchTeam t = MMT_ALL);
	void PreExecute(MUID& uidTarget, rvector& targetPos, MMatchTeam t = MMT_ALL);
...
protected:
	...
	void Use(MUID& uidTarget, rvector& targetPos, MMatchTeam t);
	void Repeat();
