...
// 퀘스트 관련 전역 클래스
class ZZombie : public ZBaseQuest
{
private:
	...
	virtual bool OnNewRound(MCommand* pCommand);
...
public :
	...
	virtual bool OnZombieKill(MCommand* pCommand);
	virtual bool OnPeerDrop(MCommand* pCommand);
...
inline void ZZombie::SetCheet(ZQuestCheetType nCheetType, bool bValue) 
{ 
	m_Cheet[nCheetType] = bValue; 
}

inline bool ZZombie::GetCheet(ZQuestCheetType nCheetType) 
{ 
