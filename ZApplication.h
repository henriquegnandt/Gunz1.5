...
typedef	map<int, MapperInfo*> Mapper;
...
protected:
	...
	//static ZAntiInjection*	m_ZAntiInjection;
...
public:
	...
	//__forceinline static MemoryManagement*	GetMemoryManagement(void);
	//__forceinline static ZAntiInjection*			GetAntiHack(void);
	...
	__forceinline unsigned int GetFileListCRC()			{ return 0; }
...
/*
__forceinline ZAntiInjection* ZApplication::GetAntiHack(void)
{
	ZApplication* pApp = GetInstance();
	if(pApp==NULL) return NULL;
	return pApp->m_ZAntiInjection;	
}*/
