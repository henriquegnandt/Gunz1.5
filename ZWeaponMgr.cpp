...
void ZWeaponMgr::AddClayMore(rvector &pos, rvector &velocity, ZCharacter* pC, float Delaytime, char *szMeshName, int nLinkedWorldItemID)
{
	ZWeaponClayMore* pWeapon = new ZWeaponClayMore;
	...
	pWeapon->m_nWorldItemID = nLinkedWorldItemID;
	pWeapon->m_fDelayTime = Delaytime;
	pWeapon->SetTeamID(pC->GetTeamID());
...
void ZWeaponMgr::AddMagic(ZSkill* pSkill, const rvector &pos, const rvector &dir,ZObject* pOwner, MMatchTeam t)
{
