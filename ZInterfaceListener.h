...
DECLARE_LISTENER(ZGetInboxFrameCallerListener)//Steven: Inbox
DECLARE_LISTENER(ZGetInboxCloseButtonListener)
DECLARE_LISTENER(ZInboxListCaller)
DECLARE_LISTENER(ZGetCustomMusicRefresh)
...
DECLARE_LISTENER(ZGetStageSettingCancelBtnListener)
