...
void ZCrossHair::GetBitmaps(MBitmap** ppoutBitmap, MBitmap** ppoutPickBitmap, ZCrossHairPreset nPreset)
{
	...
	else
	{
		...
		{
			int id = nPreset-6;
			sprintf(szBar[CH_CENTER],	"%s%s%d%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_TAILER);
			sprintf(szBar[CH_TOP],		"%s%s%d%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_TOP,	FN_CROSSHAIR_TAILER);
			sprintf(szBar[CH_BOTTOM],	"%s%s%d%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_BOTTOM,FN_CROSSHAIR_TAILER);
			sprintf(szBar[CH_LEFT],		"%s%s%d%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_LEFT,	FN_CROSSHAIR_TAILER);
			sprintf(szBar[CH_RIGHT],	"%s%s%d%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_RIGHT, FN_CROSSHAIR_TAILER);

			sprintf(szPick[CH_CENTER],	"%s%s%d%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
			sprintf(szPick[CH_TOP],		"%s%s%d%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_TOP,		FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
			sprintf(szPick[CH_BOTTOM],	"%s%s%d%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_BOTTOM,	FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
			sprintf(szPick[CH_LEFT],	"%s%s%d%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_LEFT,	FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
			sprintf(szPick[CH_RIGHT],	"%s%s%d%s%s%s", PATH_CUSTOM_CROSSHAIR, FN_CROSSHAIR_HEADER, id, FN_CROSSHAIR_RIGHT,	FN_CROSSHAIR_PICK, FN_CROSSHAIR_TAILER);
...
void ZCrossHair::Draw(MDrawContext* pDC)
{
	...
	//DrawCrossHair(pDC, m_pBitmaps, center, sizefactor, fFactor); // Steven: Shotbot Patch
	switch(m_nStatus)
	{
		case ZCS_NORMAL:	
		{
