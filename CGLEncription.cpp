...
#define DATA_MSG_INTERNATIONAL		"6as5dqw522x"
#define DATA_MSG_LAUNCHDEV			"hb2fd3ac3"
#define DATA_MSG_TEST				"g3sd2"
...
{
	return GLE_LAUNCH_INTERNATIONAL;//open gunz without launcher
	unsigned char szSerialKey[ MAX_BUF];
