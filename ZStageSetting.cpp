...
// 최대인원
#define STAGESETTING_MAXPLAYER_MAX		15
...
static struct _STAGESETTING_MAXPLAYER
{
	...
	{ {1, "1"},{2, "2"},{4, "4"}, {8, "8"}, {10, "10"}, {12, "12"}, {14, "14"}, {16, "16"} , {18, "18"}, {20, "20"}, {22, "22"}, {24, "24"}, {26, "26"}, {28, "28"}, {30, "30"} };

// 라운드
#define STAGESETTING_MAXROUND_MAX		16
...
static struct _STAGESETTING_MAXROUND
{
	...
	{10, "10"}, {20, "20"}, {30, "30"}, {50, "50"}, {70, "70"}, {100, "100"} , {200, "200"} , {300, "300"}, {400, "400"}, {500, "500"}, {600, "600"}, {700, "700"}, {800, "800"}, {900, "900"}, {1000, "1000"}, {99999, "99999"} };
...
#define STAGESETTING_GRAVITY_MAX	11
#define STAGESETTING_GRAVITY_DEFAULT 0
static struct _STAGESETTING_GRAVITY
{
	float					Value;
	char				szText[32];
} StageSetting_Gravity[STAGESETTING_GRAVITY_MAX] = { 
	{2500.f, "Normal - 100%"},{2250.f, "90%"},{2000.f, "80%"},{1750.f, "70%"},{1500.f, "60%"}, {1250.f, "50%"}, {1000.f, "40%"}, {750.f, "30%"}, {500.f, "20%"}, {250.f, "10%"}, {125.f, "5%"}};
...
/////////////////////////////////////////////////////////////////////////////////////////////
	...
	BUILD_STAGESETTING_ITEM("Gravity", pOutNode->nGravity, StageSetting_Gravity, STAGESETTING_GRAVITY_MAX);
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	//	pCBTeamBanlance->Enable( ZGetGameTypeManager()->IsTeamGame( pStageSetting->nGameType));
		if ( pCBTeamBanlance)
		pCBTeamBanlance->Enable( ZGetGameTypeManager()->IsTeamGame( pStageSetting->nGameType) && pStageSetting->nGameType != MMATCH_GAMETYPE_DEATHMATCH_TEAM_TRIPLE);	// 3 Team DM.
...
#define GET_LIMITLEVEL(_value)		sprintf(szText,"%s %d",ZMsg(MSG_WORD_LEVELDIFF),_value);
	...
	INITSTAGESETTING_ITEM("Gravity", pStageSetting->nGravity, STAGESETTING_GRAVITY_MAX, StageSetting_Gravity, STAGESETTING_GRAVITY_DEFAULT);
}
...
void ZStageSetting::InitStageSettingGameType()
{
...
#ifdef Zombies
		if (nGameType == MMATCH_GAMETYPE_QUEST || nGameType == MMATCH_GAMETYPE_SURVIVAL || nGameType == MMATCH_GAMETYPE_ZOMBIE)  
#else
	...
	#ifdef _QUEST // 퀘스트 개발용 디파인
	{
		...
		if ((ZGetGameClient()) && ((ZGetGameClient()->GetServerMode() == MSM_TEST) || (ZGetGameClient()->GetServerMode() == MSM_CLANTEST))) // server.ini에서 MODE="test"로 세팅으로 추가
		{
...
#ifdef Zombies
				pCB->Add(ZGetGameTypeManager()->GetGameTypeStr(MMATCH_GAMETYPE(MMATCH_GAMETYPE_ZOMBIE)));
#endif
//#endif
		}
	}
