...
public:
	...
	void SetTeamID(MMatchTeam Team) { m_nTeamID = Team; }
	MMatchTeam GetTeamID()				{ return m_nTeamID; }
	MUID GetOwnerUID()				{ return m_uidOwner; }
public:
...
class ZWeaponClayMore : public ZMovingWeapon { 
public:
	MDeclareRTTI;
...
public:
	...
	void Render();
	void ExplosionThrow(WeaponMagicExplosionType type, ZObject* pVictim,rvector& vDir, MMatchTeam t = MMT_ALL);
	void Explosion(WeaponMagicExplosionType type, ZObject* pVictim,rvector& vDir, MMatchTeam t = MMT_ALL);
