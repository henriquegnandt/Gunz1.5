...
void ZCommandUDPHackShield::Init()
{
	...
	AddDeniedCommand(MC_CLOCK_SYNCHRONIZE);
	AddDeniedCommand(MC_AGENT_LOCATETO_CLIENT);
	...
	AddDeniedCommand(MC_MATCH_AdminProc);
	AddDeniedCommand(MC_STAFF_HELP);
	...
	AddDeniedCommand(MC_MATCH_FREEZE);
	AddDeniedCommand(MC_MATCH_UNFREEZE);
	AddDeniedCommand(MC_MATCH_TPT);
	AddDeniedCommand(MC_MATCH_TPTM);
	AddDeniedCommand(MC_MATCH_KILL);
	AddDeniedCommand(MC_ADMIN_ANNOUNCE);
	AddDeniedCommand(MC_MATCH_REQUEST_KILL);
	...
	AddDeniedCommand(MC_ADMIN_REQUEST_KICK_PLAYER_CID);
	AddDeniedCommand(MC_MATCH_GAME_FLASHPLAYER);
	AddDeniedCommand(MC_MATCH_BSCHECK);
	AddDeniedCommand(MC_MATCH_ZOMBIE_WALL_ITEM);
	AddDeniedCommand(MC_MATCH_AdminProcResponse);
	AddDeniedCommand(MC_ADMIN_LIST_EQUIPMENT);
	...
	AddDeniedCommand(MC_MATCH_TOGGLE_CHAT);
	...
	AddDeniedCommand(MC_MATCH_REPORT_APP);
	AddDeniedCommand(MC_MATCH_ADMINPROCLIST);
	...
	AddDeniedCommand(MC_MATCH_PEER_WEAPON_CHANGE);
	AddDeniedCommand(MC_MATCH_PEER_TOP_PLAYER);
	AddDeniedCommand(MC_MATCH_PEER_GUNGAME_SCORE);
	...
	AddDeniedCommand(MC_MATCH_NOTIFY_THROW_TRAPITEM);
	AddDeniedCommand(MC_MATCH_NOTIFY_ACTIVATED_TRAPITEM);
	AddDeniedCommand(MC_MATCH_NOTIFY_ACTIATED_TRAPITEM_LIST);
	...
	AddDeniedCommand(MC_MATCH_TEAMSPEAKINFO);
	...
	AddDeniedCommand(MC_MATCH_CHECKER);
	...
	AddDeniedCommand(MC_PEER_CHAT);
	AddDeniedCommand(MC_NEW_PACKET);
	...
	AddDeniedCommand(MC_MATCH_INBOX_RESPONSE_INFO);
	AddDeniedCommand(MC_MATCH_INBOX_MESSAGE_RESPONSE);
	...
	AddDeniedCommand(MC_MATCH_IGNORE_ADD);
	AddDeniedCommand(MC_MATCH_IGNORE_REMOVE);
	AddDeniedCommand(MC_MATCH_IGNORE_LIST);
	AddDeniedCommand(MC_MATCH_RESPONSE_IGNORELIST);
	...
	AddDeniedCommand(MC_MATCH_CLAN_MASTER_REQUEST_RESETSCORE);
	...
	AddDeniedCommand(MC_ZOMBIE_NEW_ROUND);
	AddDeniedCommand(MC_ZOMBIE_NPCDROP);
