...
void ZCombatChat::Update(bool a)
{
	UpdateChattingBox(a);
...
void ZCombatChat::UpdateChattingBox(bool a)
{
	...
	if (m_pChattingOutput->GetLineCount() > 0)
	{
		...
		if (a == false && (nNowTime - m_nLastChattingMsgTime) > 5000 || a == true && (nNowTime - m_nLastChattingMsgTime) > 10000)
		{
