...
public:
	...
	void PreExcute(int nSkill,MUID uidTarget,rvector targetPosition, MMatchTeam t = MMT_ALL);	// 모션이 시작할때
	void Excute(int nSkill,MUID uidTarget,rvector targetPosition, MMatchTeam t = MMT_ALL);		// 실행한다
