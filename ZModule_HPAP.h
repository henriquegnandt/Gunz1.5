...
{
	// Lucas: Bugfix: Rounded DOWN damage to prevent 0 HP and 0 AP (they get 0/0 because it might be 0.1/0.2) 
...
{
	// Lucas: Bugfix: Rounded UP damage to prevent 0 HP and 0 AP (they get 0/0 because it might be 0.1/0.2) 
